...
public final class Constants {
  ...
  public static final class ArmConstants{
    ...
    //Measured against the hardstop when claw is over pdh
    public static final double VERTICAL_ANGLE_UPPER = OffsetConstants.UPPER_JOINT_OFFSET;
    //Measured when the lower angle is vertical using 1x1
    public static final double VERTICAL_ANGLE_LOWER = OffsetConstants.LOWER_JOINT_OFFSET;
    ...
    // Profiled PID Constants For Midnight
  ...
  public static final class ArmSetpoints{
    ...
    public static final Setpoint SUBSTATION = new Setpoint(160, 67, false, ClawState.IN, 160, 67, false, ClawState.OUT, ArmState.SUBSTATION);
