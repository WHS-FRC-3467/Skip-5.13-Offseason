...
public class ThreePieceCuby extends SequentialCommandGroup {
  /** Creates a new ThreePieceTry3. */
  public ThreePieceCuby(ArmSubsystem arm, DriveSubsystem drive, ClawSubsytem claw, CubeShooterSubsystem cuby) {
